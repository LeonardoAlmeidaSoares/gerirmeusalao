...
class Cliente extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('menu');
        $this->load->view('listagem_cliente', $parametrosListagem);
    ...
    public function cadastrar() {
        ...
        $this->load->view('barraSuperior');
        $this->load->view('menu');
        $this->load->view('cadastro_cliente', $parametrosCadastro);
        $this->load->view('footer');
    }
    ...
    public function alterar($codCliente) {
        ...
        $this->load->view('barraSuperior');
        $this->load->view('menu');
        $this->load->view('perfil_cliente', $parametrosCadastro);
        $this->load->view('footer');
    }
    ...
    public function email(){
        ...
        //$this->emails->enviarMensageUsuarioCadastrado(); 
