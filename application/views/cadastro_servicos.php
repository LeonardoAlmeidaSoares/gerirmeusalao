    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Cadastrar Serviços</h4> </div>
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input value="<?= Dataget("valorComum") * 100;?>" type="text" id="txtValor" name="txtValor" class="form-control" placeholder="Insira Valor"> 
                            </div>
                        </div>
                        <div class="form-group">
