                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input value="<?= Dataget("descricao");?>" type="text" id="txtDescricao" name="txtDescricao" class="form-control" placeholder="Descreva o Produto"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12" for="txtValorCompra">Valor de Compra</label>
                            <div class="col-md-12">
                                <input value="<?= Dataget("valorCompra") * 100;?> " type="text" id="txtValorCompra" name="txtValorCompra" class="form-control" placeholder="Insira Valor de Compra"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12" for="txtValorVenda">Valor de Venda</label>
                            <div class="col-md-12">
                                <input value="<?= Dataget("valorVenda") * 100;?>" type="text" id="txtValorVenda" name="txtValorVenda" class="form-control" placeholder="Insira o Valor de Venda"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input value="<?= Dataget("estoque");?>" type="number" id="txtEstoque" name="txtEstoque" class="form-control" placeholder="Quantidade Atual em estoque"> 
                            </div>
                        </div>
