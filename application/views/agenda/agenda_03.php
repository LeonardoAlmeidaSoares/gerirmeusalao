...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <script type="text/javascript" src="<?= base_url("assets/plugins/animatedModal.js/animatedModal.min.js");?>"></script>
        <script src="<?= base_url("assets/paginas/agenda_03.js"); ?>" type="text/javascript"></script>
    </div>
</div>
