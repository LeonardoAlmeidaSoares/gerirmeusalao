...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- row -->
        <div class="row">
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-">
                <div class="white-box">
                    <div id="calendar"></div>
                </div>
            </div>
        ...
        <script>
            var codFuncionarioSelecionado = <?= $_SESSION["dadosColaborador"]->codFuncionario;?>;
            var events = [];
        ...
        <script src="<?= base_url("assets/paginas/agendaColaborador.js"); ?>" type="text/javascript"></script>
    </div>
</div>