<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cadastrar Cargo</li>
        ...
        <form id="frmCad" enctype="multipart/form-data" class="form-material form-horizontal" 
              ...
              method="POST" action="<?= base_url("index.php/cargo/add/");?>">
                    ...
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="txtDescricao" name="txtDescricao" class="form-control" placeholder="Descrição do Cargo"> 
