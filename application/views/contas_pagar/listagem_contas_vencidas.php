        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">Listagem de Contas a Pagar Vencendo Hoje</p>
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($item->status == 0) { ?>
                                                <span class="ti-money pointer pagar" title="Pagar Conta" cod="<?= $item->codNotaSaida; ?>"></span>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <?php if ($_SESSION["permissoes"]->perm_verNotas == 2) { ?>
                            <a href="<?= base_url("index.php/contas_pagar/novo/"); ?>" class="btn btn-info pull-right">Novo</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
