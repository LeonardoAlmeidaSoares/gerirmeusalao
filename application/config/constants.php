...
define("MSG_LOGIN_NAO_ENCONTRADO", "Acesso não liberado");

define("CAMINHO_IMAGEM_CLIENTE_PADRAO","client_male.png");
...
define('CAMINHO_IMAGENS_INSTITUICAO', dirname(dirname(dirname(__FILE__))) . "\assets\upload\instituicao");


define("COD_PERMISSAO_ATENDENTE", 1 );
define("COD_PERMISSAO_GERENTE", 2);
define("COD_PERMISSAO_DONO", 3);
define("COD_PERMISSAO_COLABORADOR", 4);

define("DESC_CLIENTE_NAO_CADASTRADO", "");